...
public class CourseService {
     ...
     * 创建瑜伽课程
     */
    public ServiceResult<Course> createYogaCourse(String name, int duration, int maxCapacity, int trainerId) {
        return createCourse(name, TYPE_YOGA, duration, maxCapacity, trainerId);
    }

    /**
     * 创建动感单车课程
     */
    public ServiceResult<Course> createSpinningCourse(String name, int duration, int maxCapacity, int trainerId) {
        return createCourse(name, TYPE_SPINNING, duration, maxCapacity, trainerId);
    }

    /**
     * 创建普拉提课程
     */
    public ServiceResult<Course> createPilatesCourse(String name, int duration, int maxCapacity, int trainerId) {
        return createCourse(name, TYPE_PILATES, duration, maxCapacity, trainerId);
    }

    /**
     * 创建有氧操课程
     */
    public ServiceResult<Course> createAerobicsCourse(String name, int duration, int maxCapacity, int trainerId) {
        return createCourse(name, TYPE_AEROBICS, duration, maxCapacity, trainerId);
    }

    /**
     * 创建力量训练课程
     */
    public ServiceResult<Course> createStrengthCourse(String name, int duration, int maxCapacity, int trainerId) {
        return createCourse(name, TYPE_STRENGTH, duration, maxCapacity, trainerId);
    }
